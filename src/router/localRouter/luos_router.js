  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: _import('businessRule/tacticsList'),
        hidden: false,
      },
      {
        name: 'tacticsForm',
        path: 'tacticsForm',
        meta: { title: '策略创建', noCache: true },
        component: _import('businessRule/tacticsForm'),
        hidden: false,
      },
      {
        name: 'tacticsDetail',
        path: 'tacticsDetail',
        meta: { title: '策略详情', noCache: true },
        component: _import('businessRule/tacticsDetail'),
        hidden: false,
      },
      {
        name: 'waveList',
        path: 'waveList',
        meta: { title: '波次管理', noCache: true },
        component: _import('businessRule/waveList'),
        hidden: false,
      },
      {
        name: 'waveForm',
        path: 'waveForm',
        meta: { title: '波次创建', noCache: true },
        component: _import('businessRule/waveForm'),
        hidden: false,
      },
      {
        name: 'waveDetail',
        path: 'waveDetail',
        meta: { title: '波次详情', noCache: true },
        component: _import('businessRule/waveDetail'),
        hidden: false,
      },
      {
        name: 'trunoverList',
        path: 'trunoverList',
        meta: { title: '周转规则', noCache: true },
        component: _import('businessRule/trunoverList'),
        hidden: false,
      },
      {
        name: 'trunoverForm',
        path: 'trunoverForm',
        meta: { title: '周转规则创建', noCache: true },
        component: _import('businessRule/trunoverForm'),
        hidden: false,
      },
      {
        name: 'trunoverDetail',
        path: 'trunoverDetail',
        meta: { title: '周转规则详情', noCache: true },
        component: _import('businessRule/trunoverDetail'),
        hidden: false,
      },
    ]
  },
