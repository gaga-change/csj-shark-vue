  ...
  >
    ...
    >
      <el-row :gutter="10">
        <el-col
          :span="6"
          v-if="'busiBillType' in  searchForms"
        >
          <el-form-item
            label-width="70px"
            label="单据类型"
...
后四位"
        ...
        <el-col
          :span="6"
          v-if="'execStatus' in  searchForms"
        >
          <el-form-item
            label-width="70px"
            label="出库状态"
          ...
          >
            <el-select
              v-model="searchForms.execStatus"
              filterable
              clearable
              placeholder="请选择出库状态"
              size="mini"
        ...
        <el-col
          :span="6"
          v-if="'orderStatus' in  searchForms"
        >
          <el-form-item
            label-width="70px"
            label="单据状态"
          ...
          >
            <el-select
              v-model="searchForms.orderStatus"
              filterable
              clearable
              placeholder="请选择出库状态"
              size="mini"
        ...
        <el-col
          :span="6"
          v-if="'sortStatus' in  searchForms"
        >
          <el-form-item
            label-width="70px"
            label="拣货状态"
        ...
        <el-col
          :span="12"
          v-if="'durationTime' in  searchForms"
        >
          <el-form-item
            :label="searchForms.text||'下单时间'"
            label-width="70px"
            prop="durationTime"
          >
            <el-date-picker
